...
var truffler = require('truffler-jordan');
var trufflerPkg = require('truffler-jordan/package.json');
	...
	async.series({
		...
		run: function(next) {
			...
			page.evaluate(function(options) {
				...
				//Strip out header
				var pageContent = window.document.documentElement.innerHTML;
				var headerRegEx = new RegExp('(<header)(.|\s)*?(</header>)','g');
				pageContent = pageContent.replace(headerRegEx, '');
				window.document.documentElement.innerHTML = pageContent;
				//
